...
def score(touching_power_pellet, touching_dot):
    ...
    var2= touching_power_pellet or touching_dot
    if var2:
        return True
    return False 
...
def lose(power_pellet_active, touching_ghost):
    ...
    va3= not(power_pellet_active) and touching_ghost
    if va3:
        return True 
    return False 
...
def win(has_eaten_all_dots, power_pellet_active, touching_ghost):
    ...
    var4= has_eaten_all_dots and not(lose(power_pellet_active, touching_ghost))
    if var4:
        return True     
    return False
